...
class DictionaryValidator {
  ...
  static add = () => [
    ...
    body("type", "Type must be either HISTORICAL or MODERN.").isIn(["HISTORICAL", "MODERN"]),
  ...
  static update = () => [
    ...
    body("type", "Type must be either HISTORICAL or MODERN.").optional().isIn(["HISTORICAL", "MODERN"]),
